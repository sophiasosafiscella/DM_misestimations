...
def check_bad_lo_range(toas):
    ...
    15-yr specific mitigation strategy for excising affected data_res_avg. Will raise
...
Add the following line(s) to the ignore block of your .yaml file...
  ...
  - [57984,58447,"PUPPI"]
        ...
        log.info('Arecibo data_res_avg affected by bad LO (MJD 57984-58447) has been ignored.')
